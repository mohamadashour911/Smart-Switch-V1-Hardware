...
## 🚀 Features
* **Wireless Load Control:** Direct, peer-to-peer control over electrical appliances such as lamps and small motors[cite: 1].
...
### 2. Control Core (MCU)
* **Brain:** Powered by an **ESP32** module managing wireless peer-to-peer data layout via ESP-NOW[cite: 1].
